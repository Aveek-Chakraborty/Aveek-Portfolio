    ...
    `}</style>
      ...
      `}</style>
            ...
            <section id="projects" ref={projectsRef} className="py-12 sm:py-20 md:py-32 relative overflow-hidden">
                ...
                {/* Dynamic orange glow effect that follows active card */}
                <motion.div
                        ...
                        <div className="absolute inset-0 flex items-center justify-center perspective">
                            {projects.map((project, index) => {
                                ...
                                return (
                                    <motion.div
                                        key={project.title}
                                        className={`absolute w-full max-w-xs sm:max-w-sm md:max-w-md backdrop-blur-sm bg-black/50 rounded-xl sm:rounded-2xl border ${position === 0 ? 'border-orange-500' : 'border-gray-800'} shadow-xl overflow-hidden cursor-pointer`}
                                        style={{
                                        ...
                                        onClick={() => position === 0 ? openModal(project) : goToProject(index)}
                                    >
                                        <div className="h-32 sm:h-40 md:h-48 bg-gradient-to-br from-orange-600/20 to-black/40 relative overflow-hidden">
                                            ...
                                            {/* Project number overlay with pulse effect */}
                                            <div className="absolute inset-0 flex items-center justify-center">
                                                <motion.div
                                                    animate={{
                                                        opacity: position === 0 ? [0.2, 0.3, 0.2] : 0.15,
                                                        scale: position === 0 ? [1, 1.05, 1] : 1
                                                    }}
                                                    transition={{
                                                        duration: 3,
                                                        repeat: Infinity,
                                        ...
                                        {/* Interactive highlight effect for active card */}
                                        {position === 0 && (
                                            <motion.div
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="h-48 sm:h-56 md:h-64 relative">
                                    {/* Modal Image Placeholder - Responsive */}
                                    <img
