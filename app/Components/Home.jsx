...
export default function Home() {
    ...
    const projects = [
        ...
        },
        {
            ...
            description: 'Feature-rich social platform with messaging, user profiles, and content sharing.',
    ...
    const getSkillIcon = (icon) => {
        const iconMap = {
            ...
            'html5': <FaHtml5 />,
            'css3': <FaHtml5 />, // Using HTML5 icon as placeholder for CSS3
            ...
            <section id="projects" ref={projectsRef} className="py-20 md:py-32 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <motion.div
                        ...
                        className="text-center mb-16"
                    >
                        <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-orange-400">Featured Projects</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {projects.map((project, index) => (
                            <motion.div
                                ...
                                className="backdrop-blur-sm bg-black/30 rounded-2xl border border-gray-800 shadow-lg overflow-hidden group"
                            >
                                <div className="h-48 bg-gradient-to-br from-orange-600/20 to-black/40 relative">
                                    <div className="absolute inset-0 flex items-center justify-center text-4xl text-white/20 font-bold">
                                        Project {index + 1}
                                    </div>
                                </div>
                                <div className="p-6">
                                    <h3 className="text-xl font-bold mb-2 text-white group-hover:text-orange-400 transition-colors">{project.title}</h3>
                                    <p className="text-gray-400 mb-4 text-sm">{project.description}</p>
                                    <div className="flex flex-wrap gap-2 mb-6">
                                        {project.tech.map((tech) => (
                                            <span key={tech} className="bg-orange-900/30 text-orange-300 text-xs px-2 py-1 rounded-full">
                                                {tech}
                                            </span>
                                        ))}
                                    </div>
                                    <div className="flex justify-between">
                                        <button className="text-sm text-orange-400 hover:text-orange-300 flex items-center font-medium">
                                            <span>View Details</span>
                                            <RiArrowRightSLine className="ml-1 group-hover:translate-x-1 transition-transform" />
                                        </button>
                    ...
                    >
                        <button className="border border-orange-500 text-orange-400 hover:bg-orange-500 hover:text-white px-6 py-3 rounded-full font-medium transition-all duration-300">
                            View All Projects
                        </button>
                    </motion.div>
                </div>
